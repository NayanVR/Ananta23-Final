...
function Digitalpoint() {
   ...
   <div>
        <p className="font-bold"> What is Digital points?</p>
        <p> 
        Digital points is concept of virtual currency which you can use to play fun events(Upshot).
        </p>
        </div>
        <div>
        <p className="font-bold">Where can i use my Digital points?</p>
        ...
        <div>
        <p className="font-bold">How can i earn more Digital points?</p>
        ...
        <ul className='list-disc ml-10'>
          ...
          <li>
          Bronze Pass (₹200) : <span className='font-semibold'>2000</span> points
          </li>
          <li>
          Silver Pass (₹250) : <span className='font-semibold'>2200</span> points
          </li>

          <li>
          Gold Pass (₹300) : <span className='font-semibold'>2400</span> points
          </li>
          <li>
          Atmos Pass (₹450) : <span className='font-semibold'>2600</span> points
          </li>
          <li>
          Combo Pass (₹550) : <span className='font-semibold'>2800</span> points
          </li>
        </ul>
        </li>
