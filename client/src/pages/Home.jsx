                    ...
                    <p className=' relative uppercase text-4xl font-bold text-black z-50 top-56'>17-18-19 March</p>
                    {
                        !currentUser ?
                            ...
                            : profile.TxnStatus != "TXN_SUCCESS" ?
                                ...
                                <button className='top-52 z-50 relative before:content-[""] before:absolute before:w-full before:h-full before:top-0 before:bg-gradient-to-r before:from-transparent before:to-transparent before:via-primary-light-1 before:-left-full before:hover:left-full before:transition-all before:duration-500 hover:shadow-lg hover:shadow-primary-light-2 transition-all overflow-hidden py-2 px-16 bg-gradient-to-b from-primary-dark-1 to-primary-dark-2 text-white rounded-md' onClick={_ => { window.location.href = "/inertia" }}>Start Registration in Events</button>
                    }
                </div>
