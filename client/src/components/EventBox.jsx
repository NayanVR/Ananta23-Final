...
export default function EventBox({ title, desc, link, sub }) {
    return (
        <div className='group w-64 h-64 p-4 bg-white flex flex-col gap-4 justify-center items-center transition-all relative cursor-pointer'>
            {/* Corner circles */}
            <div className='w-2 h-2 -mt-1 -ml-1 bg-white rounded-full absolute top-0 left-0 border border-primary'></div>
            <div className='w-2 h-2 -mb-1 -mr-1 bg-white rounded-full absolute bottom-0 right-0 border border-primary'></div>
            ...
            {/* heading */}
            <div className='flex gap-4 group-hover:gap-0 flex-col justify-center items-center transition-all'>
            ...
            {/* description */}
            <div className='scale-y-0 hidden group-hover:scale-y-100 group-hover:flex flex-col justify-center items-center transition-transform'>
