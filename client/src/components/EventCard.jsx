...
function EventCard({ index }) {
  return (
    <div className='w-screen min-h-[calc(100vh-4rem)] sticky top-0 left-0 flex justify-center items-center'>
      <div style={{ zIndex: index }} className='w-3/4 h-[70vh] p-12 flex gap-4 items-center bg-primary-light-3 border-primary-light-1 border-2 rounded-md'>
